                  ...
                  <Fragment key={uuid()}>
                    {item.id === itemId ? (
                      <>
                        ...
                        <Box component='img' src={`${item.url}`} alt="imgUrl" />
                      </>
                    ) : (
                      ""
                    )}
